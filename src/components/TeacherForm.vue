        ...
        <form @submit.prevent="handleSubmit" class="bg-white p-6 rounded-lg shadow-lg">
          <div class="space-y-4">
            ...
            <div class="flex flex-col items-center">
              ...
              <input type="date" v-model="teacher.dob" placeholder="Select Date of Birth" class="mt-2 w-full max-w-md px-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required />
            </div>
